        ...
        <div class="d-flex align-items-center mt-5">
            ...
            <div class="d-flex flex-column">
                ...
                <div class="text-muted mt-1">
                    {{ Auth::user()->role->slug == 'admin' ? 'Administrator' : 'User' }}
                </div>
                <div class="navi mt-2">
                    ...
                    <a href="#" class="navi-item" onclick="event.preventDefault();
     document.getElementById('logout-form').submit();">
                        <span class="navi-link p-0 pb-2">
                            <span class="navi-icon mr-1">
                                {{ Metronic::getSVG('media/svg/icons/Navigation/Sign-out.svg', 'svg-icon-lg svg-icon-primary') }}
                            </span>
        ...
        <div class="navi navi-spacer-x-0 p-0">
                ...
                <div class="navi-link">
                    <div class="symbol symbol-40 bg-light mr-3">
                        <div class="symbol-label">
                            {{ Metronic::getSVG('media/svg/icons/Devices/Display1.svg', 'svg-icon-md svg-icon-warning') }}
                        </div>
                    </div>
                    <div class="navi-text">
            ...
            {{-- Item --}}
            <a href="{{ route('users.edit', Auth::user()->identity_token) }}" class="navi-item">
                <div class="navi-link">
                    <div class="symbol symbol-40 bg-light mr-3">
                        <div class="symbol-label">
